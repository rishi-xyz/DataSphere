...
export const Hexagon = (props: ComponentPropsWithoutRef<"svg"> & { size?: number; reverse?:boolean }) => {
    ...
    return (
        <div className="inline-flex relative">
            <svg
                ...
                className={twMerge("text-fuchsia-500/10 -rotate-45 ", className)}
                style={{
                    width: size,
                    height: size,
                }}
            ...
            {scaledLen && (
                <motion.svg
                    ...
                    strokeWidth="6"
                    xmlns="http://www.w3.org/2000/svg"
                    className={twMerge("text-fuchsia-500/65 -rotate-45 absolute ", className)}
                    style={{
